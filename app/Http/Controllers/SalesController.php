...
class SalesController extends Controller
{
    public function index()
    {
        $sales = OrderDetail::select(
            DB::raw('DATE_FORMAT("%Y-%m-%d", created_at) as date'),
    ...
    public function show(Request $request, string $date)
    {
        ...
        $sales = OrderDetail::select(
            ...
            DB::raw('SUM(total) as total'),      // Select any value of total
            DB::raw('SUM(total_cost) as total_cost')  // Select any value of total_cost
        )
