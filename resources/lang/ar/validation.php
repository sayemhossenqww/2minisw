...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'store_additional_info'   => 'المعلومات الإضافية للمتجر',
        'timezone'   => 'المنطقة زمنية',
        'date_format'   => 'صيغة التاريخ',
        'time_format'   => 'صيغة الوقت',
        'language'   => 'اللغة',
        'zip_code'   => 'الرمز البريدي',
        'company_zip_code'   => 'الرمز البريدي للشركة',
        'currency_symbol'   => 'رمز العملة',
        'currency_thousand_separator'   => 'فاصل الآلاف للعملة',
        'currency_decimal_separator'   => 'الفاصل العشري للعملة',
        'exchange_rate_currency_symbol'  => 'عملة سعر الصرف',
        ...
        'amount'  => 'المبلغ',
        'comments'  => 'التعليقات',
        'starting_cash'  => 'الرصيد الافتتاحي',
        'in_drawer_cash'  => 'الرصيد الموجود في الدرج',
        'mode'  => 'طريقة الدفع',
