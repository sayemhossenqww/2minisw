...
@section('content')
    ...
    <div class="mb-3">
        ...
        <a class="btn btn-primary" target="_blank" href=" {{ route('quotations.print', $order) }}">
            <span class=" d-flex align-items-center">
                <x-heroicon-o-printer class="hero-icon-sm me-1" /> @lang('Print')
            </span>
        </a>
        <a class="btn btn-primary" href=" {{ route('quotations.convert', $order) }}">
            <span class=" d-flex align-items-center">
                <x-heroicon-o-printer class="hero-icon-sm me-1" /> @lang('Convert to Invoice')
            </span>
        </a>
    </div>
    @if ($order->remarks)
